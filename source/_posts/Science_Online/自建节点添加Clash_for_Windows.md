---
title: 自建节点添加 Clash for Windows（模板）
tags: Science Online
author: Taniz Hugo
language: zh-CN
timezone: Asia/Shanghai
abbrlink: SO4
date: 2023-08-01 09:13:52
---


以下内容是参考Clash官方编写的conf文件

具有最新格式可以访问[clash官网](https://github.com/Dreamacro/clash/blob/master/README.md)查看，点击可跳转。


```yaml
# 支持的协议及加密算法示例请查阅 Clash 项目 README 以使用最新格式：
# HTTP(S) 代理服务端口
port: 7890
...
proxies:
- {name: "Seattle(西雅图)vmess+ws", type: vmess, server: 149.28.13.249, port: 50545, uuid: 51dd5ffb-c8aa-4619-e593-68973f9ca5af, alterId: 0, cipher: auto, udp: true, network: ws, ws-opts: {path: /51dd5ffb, headers: {Host: k.tanizhugo.top}}}

- {name: "Seattle(西雅图)[trojan]", type: trojan, server: 149.28.13.249, port: 24736, password: 8bIC9FhLKi, udp:true, sni: k.tanizhugo.top}
 # Shadowsocks
  # 支持的加密方法:
